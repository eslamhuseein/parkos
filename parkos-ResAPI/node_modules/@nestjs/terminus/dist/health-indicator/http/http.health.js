...
const logger = new logger_service_1.Logger('HttpHealthIndicator');
/**
...
let HttpHealthIndicator = class HttpHealthIndicator extends __1.HealthIndicator {
    ...
    getHttpService() {
        try {
            ...
            logger.error('It seems like "HttpService" is not available in the current context. Are you sure you imported the HttpModule from the @nestjs/axios package?');
    ...
    responseCheck(key, url, callback, _a = {}) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            const httpService = httpClient || this.getHttpService();
            try {
                const response = yield (0, rxjs_1.lastValueFrom)(httpService.request(Object.assign({ url: url.toString() }, options)));
                ...
                if ((0, utils_1.isHealthCheckError)(health_check_error_1.HealthCheckError)) {
                    throw err;
                }
                if ((0, utils_1.isError)(err)) {
                    throw new health_check_error_1.HealthCheckError(err.message, this.getStatus(key, false));
                }
                throw new health_check_error_1.HealthCheckError(err, this.getStatus(key, false));
            }
        });
    }
};
